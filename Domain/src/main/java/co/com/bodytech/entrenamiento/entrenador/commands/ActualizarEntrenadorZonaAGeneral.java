...
public class ActualizarEntrenadorZonaAGeneral extends Command {
    ...
    public ActualizarEntrenadorZonaAGeneral(EntrenadorId entrenadorId, EntrenadorZonaId entrenadorZonaId,
